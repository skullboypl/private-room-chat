...
const ERROR_PATTERNS = [
  ...
  {
    re: /zbyt wiele błędnych haseł.*?(\d+)\s*s/i,
    key: 'passwordRateLimit',
    map: ([, seconds]) => ({ seconds }),
  },
  { re: /zbyt wiele wiadomości/i, key: 'messageRateLimit' },
  ...
  { re: /nie jest już aktywny|no longer active/i, key: 'roomGone' },
];
